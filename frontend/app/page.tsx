...
export default function Home() { 
    ...
    const fetchWallets = async () => {
      if (user) {
        try {
          ...
          const response = await axios.get(`http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/listtestwallets/?userId=${userId}`);
  ...
  useEffect(() => {
    const fetchWallets = async () => {
      if (user) {
        try {
          const userId = user.id; // or user.email for email
          const response = await axios.get(`http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/listrealwallets/?userId=${userId}`);
  ...
  const deleteWallet = async (walletIndex: number): Promise<void> => {
    ...
    try {
      const response = await axios.post('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/deletetestwallet/', JSON.stringify({ 
  ...
  const handleSendXrp = async (senderAddress: string): Promise<void> => {  
    ...
    try {  
      ...
      const response = await axios.post('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/sendxrptransaction/', transactionData);  
  ...
  const fetchWalletData = async (address: string): Promise<void> => {
    try {
      const response = await axios.post('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/getaccountinfo/', { address });
      if (response.data) {
  ...
  const fetchAccountDetails = async (): Promise<void> => {
    try {
      const response = await fetch('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/getaccountinfo/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleAddWalletClick = async (): Promise<void> => {
    ...
    try {
      const response = await fetch('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/createtestwallet/', {
        method: 'POST',
  ...
  const handleNewWallet = async (): Promise<void> => {
    ...
    try {
      const response = await fetch('http://https://xrp-dashboard-backend-e11b4f6d709d.herokuapp.com/xrpapp/createwallet/', {
        method: 'POST',
        headers: headers,
      });
